...
class CI_DB_active_record extends CI_DB_driver {
		...
		foreach ((array) $from as $val) {
			if (strpos($val, ',') !== FALSE) {
				foreach (explode(',', $val) as $v) {
					...
					$this->ar_from[] = $this->_protect_identifiers($v, TRUE, $escape, FALSE);

					if ($this->ar_caching === TRUE) {
						$this->ar_cache_from[]   = $this->_protect_identifiers($v, TRUE, $escape, FALSE);
				...
				$this->ar_from[] = $this->_protect_identifiers($val, TRUE, $escape, FALSE);

				if ($this->ar_caching === TRUE) {
					$this->ar_cache_from[]   = $this->_protect_identifiers($val, TRUE, $escape, FALSE);
					$this->ar_cache_exists[] = 'from';
				}
			}
		}
	...
	public function join($table, $cond, $type = '', $escape=NULL) {
		...
		$join = $type.'JOIN '.$this->_protect_identifiers($table, TRUE, $escape, FALSE).' ON '.$cond;
